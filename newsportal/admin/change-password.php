...
$sql=mysqli_query($con,"SELECT tbladmin.User_Password FROM  tbladmin WHERE User_Name='$adminid' || User_Email='$adminid'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $dbpassword=$num['User_Password'];

if (password_verify($password, $dbpassword)) {

$sql1=mysqli_query($con,"UPDATE tbladmin SET User_Password='$newhashedpass', UpdationDate='$currentTime' WHERE User_Name='$adminid'");
