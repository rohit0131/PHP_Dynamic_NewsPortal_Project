                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-0 table-colored-bordered table-bordered-primary">
                                            ...
                                            <tbody>
                                                ...
                                                $query=mysqli_query($con,"SELECT tblcomments.ID, tblcomments.Name,tblcomments.Email,tblcomments.postingDate,tblcomments.Comment,tblposts.Post_ID AS postid,tblposts.Post_Title FROM  tblcomments JOIN tblposts ON tblposts.Post_ID = tblcomments.Post_ID WHERE tblcomments.status=0");
                                                $cnt=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a
                                                            href="edit-post.php?pid=<?php echo htmlentities($row['postid']);?>">
