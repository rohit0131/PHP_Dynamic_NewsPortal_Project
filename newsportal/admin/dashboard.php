    ...
    <div id="wrapper">
        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <a href="index.php" class="logo"><span> NP<span></span></span><i class="mdi mdi-layers"></i></a>
                <!-- Image logo -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <a href="manage-posts.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one bg-info">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow"
                        ...
                        <a href="manage-subadmins.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one bg-info">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow"
                                            title="User This Month">No Of User</p>
                                        <?php $query=mysqli_query($con,"SELECT * FROM tbladmin");
                                           $countposts=mysqli_num_rows($query);
                                         ?>
                                        <h2>
                                            <?php echo htmlentities($countposts);?> <small></small>
