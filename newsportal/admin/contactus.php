<?php 
    ...
    $query=mysqli_query($con,"UPDATE `tblpages` SET `Page_Title`='$pagetitle',`Description`='$pagedetails'WHERE `Page_Name`='$pagetype' ");
    if($query)
    {
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <?php 
                        $pagetype='contactus';
                        $query=mysqli_query($con,"SELECT `Page_Title`,`Description` FROM `tblpages` WHERE `Page_Name`='$pagetype'");
                                    ...
                                    <form name="aboutus" method="post">
                                        <div class="form-group m-b-20">
                                            ...
                                            <input type="text" class="form-control" id="pagetitle" name="pagetitle"
                                                value="<?php echo htmlentities($row['Page_Title'])?>" required>
                                        </div>
