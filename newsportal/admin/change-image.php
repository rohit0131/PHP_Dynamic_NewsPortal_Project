<?php 
    ...
    $query=mysqli_query($con,"UPDATE tblposts set Post_Image='$imgnewfile' where Post_ID='$postid'");
    if($query)
    {
            ...
            <div class="content">
                <div class="container">
                    ...
                    <form name="addpost" method="post" enctype="multipart/form-data">
                        <?php
                            $postid=intval($_GET['pid']);
                            $query=mysqli_query($con,"SELECT Post_Image,Post_Title FROM tblposts WHERE Post_ID='$postid' AND Is_Active=1 ");
                                        ...
                                        <form name="addpost" method="post">
                                            <div class="form-group m-b-20">
                                                ...
                                                <input type="text" class="form-control" id="posttitle"
                                                    value="<?php echo htmlentities($row['Post_Title']);?>"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-box">
                                                        ...
                                                        <img src="postimages/<?php echo htmlentities($row['Post_Image']);?>"
                                                            width="300" />
                                                        <br />
