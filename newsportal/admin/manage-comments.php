                                ...
                                <div class="demo-box m-t-20">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-0 table-colored-bordered table-bordered-primary">
                                            ...
                                            <tbody>
                                                <?php 
                                                $query=mysqli_query($con,"SELECT tblcomments.ID,tblcomments.Name,tblcomments.Email,tblcomments.postingDate,tblcomments.Comment,tblposts.Post_ID AS postid,tblposts.Post_Title FROM  tblcomments JOIN tblposts ON tblposts.Post_ID=tblcomments.Post_ID WHERE tblcomments.status=1");
                                                $cnt=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a
                                                            href="edit-post.php?pid=<?php echo htmlentities($row['Post_ID']);?>">
                                                            <?php echo htmlentities($row['Post_Title']);?>
                                                        </a> </td>
                                                    <td>
