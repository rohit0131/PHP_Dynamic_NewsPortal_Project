                                ...
                                <div class="demo-box m-t-20">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-0 table-colored-bordered table-bordered-primary">
                                            ...
                                            <tbody>
                                                <?php 
                                                 $query=mysqli_query($con,"SELECT `Cat_ID`,`Cat_Name`,`Description`,`PostingDate`,`UpdationDate` FROM `tblcategory` WHERE `Is_Active`=1");
                                                    $cnt=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a
                                                            href="edit-category.php?cid=<?php echo htmlentities($row['Cat_ID']);?>"><i
                                                                class="fa fa-pencil" style="color: #29b6f6;"></i></a>
                                                        &nbsp;<a
                                                            href="manage-categories.php?rid=<?php echo htmlentities($row['Cat_ID']);?>&&action=del">
                                ...
                                <div class="demo-box m-t-20">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-0 table-colored-bordered table-bordered-danger">
                                            ...
                                            <tbody>
                                                <?php 
                                                $query=mysqli_query($con,"SELECT `Cat_ID`, `Cat_Name`,`Description`,`PostingDate`,`UpdationDate` FROM  `tblcategory` WHERE `Is_Active`=0");
                                                $cnt=1; $rowcount=mysqli_num_rows($query);
                                                if($rowcount==0)
                                                {
                                                ?>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a
                                                            href="manage-categories.php?resid=<?php echo htmlentities($row['Cat_ID']);?>"><i
                                                                class="ion-arrow-return-right"
                                                                title="Restore this category"></i></a>
                                                        &nbsp;<a
                                                            href="manage-categories.php?rid=<?php echo htmlentities($row['Cat_ID']);?>&& action=parmdel"
