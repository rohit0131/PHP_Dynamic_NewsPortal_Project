...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"DELETE FROM tbladmin WHERE User_ID='$id' && userType=0");
...
?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo htmlentities($row['User_Email']);?>
                                                </td>
                                                <td>
                                                ...
                                                <td><a
                                                        href="edit-subadmin.php?said=<?php echo htmlentities($row['User_ID']);?>"><i
                                                            class="fa fa-pencil" style="color: #29b6f6;"></i></a>
                                                    &nbsp;<a
                                                        href="manage-subadmins.php?rid=<?php echo htmlentities($row['User_ID']);?>&&action=del">
