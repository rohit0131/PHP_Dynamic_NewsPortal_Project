<?php
    ...
    $email=$_POST['emailid'];
    $query=mysqli_query($con,"UPDATE  tbladmin SET User_Email='$email'  WHERE userType=0 && User_ID='$aid'");
    if($query)
    {
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                ...
                                <?php 
                                    $aid=intval($_GET['said']);
                                    $query=mysqli_query($con,"SELECT * FROM tbladmin WHERE userType=0 && User_ID='$aid'");
                                    $cnt=1;
                                    ...
                                    <div class="col-md-6">
                                        <form class="form-horizontal" name="suadmin" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control"
                                                        value="<?php echo htmlentities($row['User_Email']);?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control"
                                                        value="<?php echo htmlentities($row['CreationDate']);?>"
                                                        name="cdate" readonly>
                                                </div>
                                            </div>
