...
$usertype='0';
 $sql="INSERT INTO tbladmin (User_Name,User_Email,User_Password,UserType ) VALUES('$username','$email','$password','$usertype')";
                                    ...
                                    <div class="col-md-6">
                                        <form class="form-horizontal" name="addsuadmin" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter Sub-Admin Username" name="u_name"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="emailid" name="u_email"
