...
$sql =mysqli_query($con,"SELECT tbladmin.User_Name,tbladmin.User_Email,tbladmin.User_Password,tbladmin.userType FROM tbladmin WHERE (User_Name='$uname' && User_Password='$password')");
...
<style>
     body{
        ...
        .wrapper-page {
            background-color: rgba(23, 39, 45, 0.534);
            border-radius: 20px;
        }
</style>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages">
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.php" class="text-success">
                                            <span><h3 class="text-white">Admin</h3></span>
                                        </a>
                                    </h2>
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <a href="forgot-password.php" class="text-white"><i class="mdi mdi-lock"></i > Forgot your password?</a>
                                            <hr>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                ...
                                <a href="/newsportal/admin/index.php" class="text-white " ><i class="mdi mdi-home"></i> Back Home</a>
                                </div>
                            </div>
                            <!-- end card-box-->
