...
$password=md5($_POST['newpassword']);
        $query=mysqli_query($con,"SELECT User_ID FROM tbladmin WHERE  User_Email='$email' AND User_Name='$username' ");
        
    $ret=mysqli_num_rows($query);
    if($ret>0){
      $query1=mysqli_query($con,"UPDATE tbladmin SET User_Password='$password'  WHERE  User_Email='$email' && User_Name='$username' ");
       if($query1)
   {
